...
- [x] 39 nodes มี continueOnFail=True ใน ocr-invoice-processor (6 critical ✅)
- [x] Dashboard แสดง fuel 97.9% ≥ 95%, other 85.7% ≥ 80%
- [x] **CC final re-check (2026-03-02):** invoice_number `# *` rule confirmed LIVE in exec 155597 — `เครื่องหมายพิเศษ` text found in Gemini request payload ✅
