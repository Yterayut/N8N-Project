...
- invoice_number: ให้ค้นหาคำว่า "เลขที่", "No.", "Invoice No.", "เลขที่ใบกำกับ" ห้ามนำเลขลำดับรายการหรือเลขคิวมาใส่ หากมีตัวอักษรภาษาอังกฤษนำหน้า (Prefix) ให้ใส่มาให้ครบทุกตัว ห้ามนำสัญลักษณ์ # * หรือเครื่องหมายพิเศษอื่น ๆ มาใส่นำหน้าเลขที่
