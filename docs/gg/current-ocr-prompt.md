...
- vendor_tax_id ต้องเป็นตัวเลข 13 หลัก ขึ้นต้นด้วย 0 อ่านทีละหลักให้ครบ ห้ามอ่านผิด
- ตัวเลขเป็น number (ห้าม comma) เก็บทศนิยมตามบิล
- field ที่ไม่มีในบิลนั้น ให้ใส่ "" หรือ 0
- ถ้าอ่านไม่ได้ให้ใส่ "" หรือ 0 ห้ามเดา
- vendor_tax_id ให้อ่านซ้ำ 2 รอบเพื่อตรวจสอบความถูกต้อง
...
- total ดูจาก "รวมเป็นเงิน" เท่านั้น
